...
{
    [TestClass]
    public class FasterPaymentsServiceTests
    {
        ...
        private FasterPaymentsService _fasterPaymentService;
        ...
        public void Setup()
        {
            ...
            // Instantiate FasterPaymentService
            _fasterPaymentService = new FasterPaymentsService(
        ...
        public void MakePayment_WhenAllValidationsPass_ShouldReturnSuccess()
        {
            ...
            _mockAccountValidator.Setup(v => v.ValidateAccount(debitAccount, AllowedPaymentSchemes.FasterPayments)).Returns(true);
            _mockAccountValidator.Setup(v => v.ValidateAccount(creditAccount, AllowedPaymentSchemes.FasterPayments)).Returns(true);
            _mockPaymentValidator.Setup(v => v.ValidatePayment(request, PaymentScheme.FasterPayments)).Returns(true);

            // Act
            var result = _fasterPaymentService.MakePayment(request);
        ...
        public void MakePayment_WhenDebtorAccountFailsValidation_ShouldReturnFailure()
        {
            ...
            _mockAccountDataStore.Setup(s => s.GetAccount("123456")).Returns(debitAccount);
            _mockAccountValidator.Setup(v => v.ValidateAccount(debitAccount, AllowedPaymentSchemes.FasterPayments)).Returns(false);
        ...
        public void MakePayment_WhenCreditorAccountFailsValidation_ShouldReturnFailure()
        {
            ...
            _mockAccountDataStore.Setup(s => s.GetAccount("654321")).Returns(creditAccount);
            _mockAccountValidator.Setup(v => v.ValidateAccount(creditAccount, AllowedPaymentSchemes.FasterPayments)).Returns(false);
        ...
        public void MakePayment_WhenPaymentValidationFails_ShouldReturnFailure()
        {
            ...
            _mockAccountValidator.Setup(v => v.ValidateAccount(debitAccount, AllowedPaymentSchemes.FasterPayments)).Returns(true);
            _mockAccountValidator.Setup(v => v.ValidateAccount(creditAccount, AllowedPaymentSchemes.FasterPayments)).Returns(true);
            _mockPaymentValidator.Setup(v => v.ValidatePayment(request, PaymentScheme.FasterPayments)).Returns(false);
